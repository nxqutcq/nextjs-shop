      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
        ...
        <div>
          ...
          <ul className='text-xs'>
            ...
            <li className="mb-2">
              <a className="hover:text-neutral-500 cursor-pointer transition-colors">
                Catalog
              </a>
            </li>
            <li className="mb-2">
        ...
        <div>
          ...
          <p className="text-xs">Phone: +1 (123) 456-7890</p>
          <p className="text-xs">Email: info@shop.com</p>
          <div className="flex space-x-4 mt-4">
            ...
            <a className="hover:text-neutral-500 transition-colors cursor-pointer">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6"
                fill="currentColor"
